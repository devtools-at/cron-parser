...
<p align="center">
  <a href="https://devtools.at/tools/cron-parser"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Parse and explain cron expressions</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/cron-parser">Try Online</a> •
...
**[Try Cron Parser online at DevTools.at →](https://devtools.at/tools/cron-parser)**
...
Parse and explain cron expressions. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/cron-parser';
